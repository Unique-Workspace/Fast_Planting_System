...
class Ui_ConfigDialog(object):
    def setupUi(self, ConfigDialog):
        ...
        self.spinBox_hmin = QtGui.QDoubleSpinBox(self.widget)
        ...
        self.spinBox_wtmax = QtGui.QDoubleSpinBox(self.widget)
        ...
        self.spinBox_tmin = QtGui.QDoubleSpinBox(self.widget)
        ...
        self.spinBox_tmin.setMinimumSize(QtCore.QSize(0, 28))
        ...
        self.spinBox_wtmin = QtGui.QDoubleSpinBox(self.widget)
        ...
        self.spinBox_hmax = QtGui.QDoubleSpinBox(self.widget)
        ...
        self.radioBtn_openLed = QtGui.QRadioButton(self.widget)
        ...
        self.radioBtn_closeLed = QtGui.QRadioButton(self.widget)
